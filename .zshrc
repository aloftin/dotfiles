...
### OLD FILE CONTENT BELOW - MAYBE REFERENCE FOR FUTURE CONFIGS ###
...
# # Old Zsh plugin setup using Antidote and Powerlevel10k
# # Moving to a simplier approach for now
# # I may want to switch to Zinit or Zplug in the future
